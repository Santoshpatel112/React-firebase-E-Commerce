                            ...
                            <td className="px-6 py-4">
                              <div className="flex gap-2">
                                <div 
                                  ...
                                  style={{ color: mode === "dark" ? "white" : "" }}
                                >
                                  <div onClick={() => deleteProduct(item)} className="mr-2">
                                    <svg
              ...
              <div className="px-4 md:px-0 mb-16">
                ...
                <div className="relative overflow-x-auto">
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                      {order.flatMap((orderItem, orderIndex) => 
                        orderItem.cartitem?.map((item, itemIndex) => (
                          ...
                          >
                            <td className="px-6 py-4">{orderItem.paymentId || 'N/A'}</td>
                            <td className="px-6 py-4">
                              <img 
                                className="w-16" 
                            ...
                            <td className="px-6 py-4">{item.title || 'N/A'}</td>
                            <td className="px-6 py-4">₹{item.price || 'N/A'}</td>
                            <td className="px-6 py-4">{item.category || 'N/A'}</td>
                            <td className="px-6 py-4">{orderItem.addressinfo?.name || 'N/A'}</td>
                            <td className="px-6 py-4">{orderItem.addressinfo?.address || 'N/A'}</td>
                            <td className="px-6 py-4">{orderItem.date || 'N/A'}</td>
                          </tr>
                        ))
                      )}
                    </tbody>
